    ...
    render() {
        return html`
            ...
            <dbp-knowledge-base-web-page-element-view-demo
                ...
                no-auth></dbp-knowledge-base-web-page-element-view-demo>
        `;
    }
}

commonUtils.defineCustomElement(
    'dbp-knowledge-base-web-page-element-view-demo-activity',
    KnowledgeBaseWebPageElementViewDemoActivity
);
