...
function Keycloak(config) {
        ...
        if (token) {
            ...
            if (kc.timeSkew != null) {
                ...
                if (kc.onTokenExpired) {
                    var expiresIn =
                        (kc.tokenParsed['exp'] - new Date().getTime() / 1000 + kc.timeSkew) * 1000;
    ...
    function check3pCookiesSupported() {
        ...
        if (
            (loginIframe.enable || kc.silentCheckSsoRedirectUri) &&
            typeof kc.endpoints.thirdPartyCookiesIframe === 'function'
        ) {
            var iframe = document.createElement('iframe');
...
//# sourceMappingURL=keycloak.BSiy8LsL.es.js.map
